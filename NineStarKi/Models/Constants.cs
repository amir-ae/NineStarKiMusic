...
namespace NineStarKi.Models
{
    public static class Constants
    {
        ...
        public static List<Occasion> Occasions = new List<Occasion> {
            new Occasion { Name = "PLAY THIS FOR THE KIDS" },
            new Occasion { Name = "ROMANCE ENHANCERS" },
            new Occasion { Name = "SUPERMAN'S EARBUDS" },
            new Occasion { Name = "LAZY SUNDAY MORNING" },
            new Occasion { Name = "CARDIO WORKOUT" },
            new Occasion { Name = "MUSIC TO INSPIRE REFLECTION" },
            new Occasion { Name = "COCKTAIL HOUR" },
            new Occasion { Name = "GET THE PARTY STARTED" },
            new Occasion { Name = "ROADTRIP SOUNDTRACK AM" },
            new Occasion { Name = "ROADTRIP SOUNDTRACK PM" },
            new Occasion { Name = "HEADPHONE JOURNEY" },
