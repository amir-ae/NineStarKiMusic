    ...
    public static class MusicData
    {
        public static void Add(Repository Repository)
        {
            ...
            List<Occasion> Occasions = new List<Occasion> {
                new Occasion { Id = 0, Name = "PLAY THIS FOR THE KIDS" },
                new Occasion { Id = 1, Name = "ROMANCE ENHANCERS" },
                new Occasion { Id = 2, Name = "SUPERMAN'S EARBUDS" },
                new Occasion { Id = 3, Name = "LAZY SUNDAY MORNING" },
                new Occasion { Id = 4, Name = "CARDIO WORKOUT" },
                new Occasion { Id = 5, Name = "MUSIC TO INSPIRE REFLECTION" },
                new Occasion { Id = 6, Name = "COCKTAIL HOUR" },
                new Occasion { Id = 7, Name = "GET THE PARTY STARTED" },
                new Occasion { Id = 8, Name = "ROADTRIP SOUNDTRACK AM" },
                new Occasion { Id = 9, Name = "ROADTRIP SOUNDTRACK PM" },
                new Occasion { Id = 10, Name = "HEADPHONE JOURNEY" },
